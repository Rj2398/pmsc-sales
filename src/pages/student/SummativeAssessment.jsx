    ...
    <>
      <div className="baseline-ass-wrp">
        ...
        <div className="sub-detail-top">
          <h1 className="mb-2">
            {subjectDetail?.Subject} - Summative Assessment <span className="text-black"><b>{progress}%</b></span>
          </h1>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleFinish(); }}>
          ...
          <div className="bottom-cta">
            <Link className={`previous-cta ${currentIndex === 0 ? 'disabled' : ''}`} onClick={handlePrevious} >
            ...
            {currentIndex < totalQuestions - 1 ? (
              ...
              <button type="submit" className="finish-cta">Finish Summative Assessment</button>
            )}
          </div>
        </form>
      </div>
      ...
      {/* Quit Modal */}
      <Modal show={showQuitModal} onHide={() => setShowQuitModal(false)} className="my-popup"
        dialogClassName="custom-quit-modal" centered >
          ...
          <Modal.Body>
            <div className="delete-pop-wrap">
              <div className="delete-pop-inner text-center " >
                ...
                <p style={{ fontWeight: "700" }}>Are you sure you want to quit this Summative Assessment?</p>
              </div>
