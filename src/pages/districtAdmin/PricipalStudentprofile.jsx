	...
	return (
		<div>
			...
			<div className="student-short-info">
				<h3> {studentProfileInfo?.student_name} <span style={{width:"50px"}}></span> </h3>
						...
						<table>
							...
							<tbody>
										...
										<div className="prog">
											...
											<div className="progress">
												<div className="progress-bar" style={{ 
													...
													backgroundColor: (["not_started", "not_completed", "in_progress", "retake", "review"].includes(studentProfileInfo?.baseline_status) ? "#F28100" : "#16a34a"),
												}}
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td>
										<div className={`status ${["not_started", "locked", ""].includes(studentProfileInfo?.lesson_overall_status) && "inactive"} ${["not_completed", "in_progress","retake"].includes(studentProfileInfo?.lesson_overall_status) && "review"}`}>{studentProfileInfo?.lesson_overall_status?.replace(/_/g, " ")
								...
								<tr>
									...
									{showFullDetails && !["not_started", "not_completed", "in_progress", "locked"].includes(studentProfileInfo?.summative_status) && (
										<td>
											<Link to={ principalComing ? "/district-admin/student/summative" : teacherStudentComing ? "/district-admin/students-summative":  principalstudentBaseline ? "/district-admin-student-summative" : "/district-admin/student-summative" }
