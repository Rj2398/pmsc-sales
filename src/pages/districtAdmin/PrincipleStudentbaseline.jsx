    ...
    <>
			...
			<div className="sub-detail-wrap baseline-ass-wrp">
				<div className="sub-detail-top">
					<h1 className="mb-2">{baslineTest.subject_name} Baseline Assessment <span className="pe-4 text-black"> Score: {subject.percentage}%</span>
					</h1>
				
					<div className="sub-pro mb-0">
						<ul>
							<li><img src="/images/subject-detail/lessons.svg" alt=''/> {subject.total_lessons} lessons</li>
							<li style={{color: "#4126A8"}}><img src="/images/subject-detail/quizzes.svg" alt=''/> {subject.total_lesson_quizzes} Quizzes
							</li>
						</ul>
				...
				<div className="assessment-result baseline-top border-0 p-0">
					<div className="baseline-ass-q-a drop-list">
						<h2><img src="/images/dashboard/earned-certificates/earned-certi.svg" alt='earned-certi'/> Submitted assessment answers
						</h2>
						{(answer.length === 0) ? (
