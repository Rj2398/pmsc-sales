...
const PrincipleSummative = () => {
  ...
  const summativeTest = allQuestionAnswer?.baseline_test || {};
    ...
    <>
      <div className="sub-detail-wrap baseline-ass-wrp">
        <div className="sub-detail-top">
          <h1 className="mb-2">
            {summativeTest.subject_name} Summative Assessment
            <span className="pe-4 text-black"> Score: {subject.percentage}% </span>
          </h1>

          <div className="sub-pro mb-0">
            <ul>
              <li> <img src="/images/subject-detail/lessons.svg" alt="lessons" /> {subject.total_lessons} lessons </li>
              <li style={{ color: "#4126A8" }}>
                <img src="/images/subject-detail/quizzes.svg" alt="quizzes" />
                {subject.total_lesson_quizzes}
                Quizzes
              </li>
            </ul>

            <b className="completed">{summativeTest.status}</b>
          </div>
        </div>
              ...
              <div className="asse-complete-q-a" key={answer.quiz_id || index}>
                ...
                {answer?.selected_option ? (
                  <p className="ps-0 d-flex gap-2 justify-content-start">
                    ...
                    <img src="/images/baseline-assessment/radio-icon.svg" alt="radio icon" />
                    {answer?.selected_option}
                  </p>
                ) : (
                  <p className="ps-0 d-flex gap-2 justify-content-start">
...
export default PrincipleSummative;
