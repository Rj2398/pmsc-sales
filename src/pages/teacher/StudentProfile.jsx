          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div className={`status ${["not_started", "locked", ""].includes(studentProfileInfo?.baseline_status) && "inactive"} ${["not_completed", "in_progress"].includes(studentProfileInfo?.baseline_status) && "review"}`}>
                    {studentProfileInfo?.baseline_status?.replace(/_/g, " ")
                      .replace(/\b\w/g, (char) => char.toUpperCase()) || "Not Started"}
                  </div>
                </td>
                <td>
                  {showFullDetails &&  !["not_started", "not_completed", "in_progress", "locked"].includes(studentProfileInfo?.baseline_status) && (
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>
                  <div className={`status ${["not_started", "locked", ""].includes(studentProfileInfo?.lesson_overall_status) && "inactive"} ${["not_completed", "in_progress", ""].includes(studentProfileInfo?.lesson_overall_status) && "review"}`}>{studentProfileInfo?.lesson_overall_status?.replace(/_/g, " ")
              ...
              {studentProfileInfo?.lesson_wise?.map((lesson, index) => (
                <tr key={index} className="lessons-list" style={ showAllLession ? {} : { display: "none" } } >
                  ...
                  <td>
                    <div className={`status ${["not_started", "locked"].includes(lesson?.status) && "inactive"} ${["not_completed", "in_progress", "review"].includes(lesson?.status) && "review"}`} >
              ...
              <tr>
                ...
                <td>
                  <div className={`status ${["locked", "not_started", ""].includes(studentProfileInfo?.summative_status) && "inactive"} ${["not_completed", "in_progress"].includes(studentProfileInfo?.summative_status) && "review"}`}>
