                ...
                <div className="sub-detail-top">
                    ...
                    <div className="sub-pro mb-0">
                        <ul>
                            ...
                            <li style={{ color: "#4126A8" }}><img src="../images/subject-detail/quizzes.svg" alt="" /> {subject?.total_lesson_quizzes} Quizzes </li>
                        </ul>

                        <b className="completed">{baslineTest?.status?.replace(/_/g, " ").replace(/\b\w/g, (char) => char.toUpperCase())}</b> 
                    </div>
                </div>
