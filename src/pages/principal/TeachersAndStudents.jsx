...
const TeachersAndStudents = () => {
  ...
  useEffect(() => {
    if (selectedLevel) {
      ...
      dispatch(
        getTeacherDetails({ level_id: selectedLevel, search: searchQuery })
      );
    }
  ...
  const handleTeacherClick = (id) => {
    dispatch(studentList({ teacher_id: id }));
  ...
  //   const [navigationPageStudent, setNavigationPageStudent] = useState(1);
  //   const itemsPerPageStudent = 5;
  //   const totalPagesStudent = Math.ceil(studentData.length / itemsPerPageStudent);

  //   const startIndexStudent = (currentPageStudent - 1) * itemsPerPageStudent;
  //   const endIndexStudent = startIndexStudent + itemsPerPageStudent;
  //   const currentItemsStudent = studentData.slice(
  //     startIndexStudent,
  //     endIndexStudent
  //   );

  //   // This function is for "Previous" and "Next" buttons only
  //   const handlePageNumberClickStudent = (pageNumber) => {
  //     setCurrentPageStudent(pageNumber);
  //   };

  //   const handleNavigateStudent = (direction) => {
  //     if (direction === "next" && navigationPageStudent < totalPagesStudent) {
  //       setNavigationPageStudent(navigationPageStudent + 1);
  //       setCurrentPageStudent(navigationPageStudent + 1);
  //     } else if (direction === "prev" && navigationPageStudent > 1) {
  //       setNavigationPageStudent(navigationPageStudent - 1);
  //       setCurrentPageStudent(navigationPageStudent - 1);
  //     }
  //   };

  //   const getPageNumbersStudent = () => {
  //     const pageNumbers = [];
  //     const startPage = navigationPageStudent;
  //     const endPage = Math.min(navigationPageStudent + 1, totalPagesStudent);
