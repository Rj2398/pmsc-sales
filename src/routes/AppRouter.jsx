    ...
    <Routes>
      ...
      <Route element={<RoleBasedRoute allowedRoles={[Roles.TEACHER]} />}>
        <Route element={<TeacherLayout />}>
          ...
          <Route
            path="/teacher/progress-and-score"
            element={<TeacherProgressAndScore />}
          />
          <Route path="/teacher/profile" element={<TeacherProfile />} />
          <Route
            path="/teacher/class-detail/:subjectId"
          ...
          <Route
            path="/teacher/subject-baseline-detail/:subjectId"
            element={<TeacherSubjectBaselineDetail />}
          />
          <Route
            path="/teacher/subject-detail/:subjectId"
            element={<TeacherSubjectDetail />}
          />
          <Route
            path="/teacher/subject-summative-detail/:subjectId"
            element={<TeacherSubjectSummativeDetail />}
          />
          <Route
            path="/teacher/subject-lesson-detail/:subjectId/:lessonId"
            element={<TeacherSubjectLessonDetail />}
          />
          {/* <Route path="/teacher/mwl-micro-credentials-domain-training" element={<TeacherMwlMicroCredentialsDomainTraining />} /> */}
          <Route
            path="/teacher/mwl-training"
            element={<TeacherMwlMicroCredentialsDomainTraining />}
          />

          <Route
            path="/teacher/mwl-micro-credentials-domain-training-subject"
            element={<TeacherMwlMicroCredentialsDomainTrainingSubject />}
          />
          <Route
            path="/teacher/mwl-onboarding"
            element={<TeacherMwlOnboarding />}
          />
          <Route
            path="/teacher/mwl-parent-training"
            element={<TeacherMwlParentTraining />}
          />
          <Route
            path="/teacher/mwl-lesson-prep"
            element={<TeacherMwlLessonPrep />}
          />
          <Route
            path="/teacher/mwl-lesson-prep-subject"
            element={<TeacherMwlLessonPrepSubject />}
          />
          <Route
            path="/teacher/mwl-lesson-prep-lesson"
            element={<TeacherMwlLessonPrepLesson />}
          />
          <Route
            path="/teacher/mwl-micro-credentials-domain-training-lesson"
            element={<TeacherMwlMicroCredentialsDomainTrainingLesson />}
          />
          <Route
            path="/teacher/student-lesson-quiz"
            element={<TeacherStudentLessonQuiz />}
          />
          <Route
            path="/teacher/student-baseline-assessment"
            element={<TeacherStudentBaselineAssessment />}
          />
          <Route
            path="/teacher/student-summative-assessment"
            element={<TeacherStudentSummativeAssessment />}
          />

          <Route
            path="/teacher/progress-student-baseline-assessment"
            element={<TeacherStudentBaselineAssessment />}
          />
          <Route
            path="/teacher/progress-student-lesson-quiz"
            element={<TeacherStudentLessonQuiz />}
          />
          <Route
            path="/teacher/progress-student-summative-assessment"
            element={<TeacherStudentSummativeAssessment />}
          />
      ...
      <Route element={<RoleBasedRoute allowedRoles={[Roles.PRINCIPAL]} />}>
        <Route element={<PrincipalLayout />}>
          ...
          <Route
            ...
            element={<TeachersAndStudents />}
          />
          <Route path="/principal/profile" element={<PrincipalProfile />} />
          <Route
            path="/principal/class-detail/:subjectId"
            element={<Classdetails />}
          />
          <Route
            path="/principal/student-profile"
            element={<PricipalStudentprofile />}
          />
          <Route
            path="/principal/student-baseline-assesment"
            element={<PrincipleStudentbaseline />}
          />
          <Route
            path="/principal/student-lesson-quiz/:studentId"
            element={<PrincipleStudentLessonquiz />}
          />
          <Route
            path="/principal/student-subject-summative/:subjectId"
            element={<PrincipleSubjectSummativedetails />}
          />
          <Route
            path="/principal/student-subject-detail/:subjectId"
            element={<PrincipleSubjectDetails />}
          />
          <Route
            path="/principal/subject-baseline-detail/:subjectId"
            element={<SubjectBaselinedetails />}
          />
          <Route
            path="/principal/subject-lesson-detail/:subjectId/:lessonId"
            element={<SubjectLessondetail />}
          />

          <Route
            path="/principal/teacher-profile"
            element={<PrincipalTeacherProfile />}
          />
          <Route
            path="/principal/student-summative"
            element={<PrincipleSummative />}
          />
          <Route
            path="/principal/progress-and-score"
            element={<PrincipalProgressAndScore />}
          />
          <Route
            path="/principal/progress-student-baseline-assessment"
            element={<PrincipleStudentbaseline />}
          />
          <Route
            path="/principal/progress-student-summative-assessment"
            element={<PrincipleSummative />}
          />
          <Route
            path="/principal/progress-student-lesson-quiz"
            element={<PrincipleStudentLessonquiz />}
          />
          ...
          />
          <Route
            path="/principal/students/profile"
            element={<PricipalStudentprofile />}
          />
          <Route
            path="/principal-student-profiles"
            element={<PricipalStudentprofile />}
          />
          <Route
            path="/principal/class/detail/:subjectId"
          ...
          />
          <Route
            path="/principal/students-summative"
            element={<PrincipleSummative />}
          />
          <Route
            path="/principal/student-lesson/quiz/:studentId"
      ...
      <Route element={<RoleBasedRoute allowedRoles={[Roles.ADMIN]} />}>
        <Route element={<DistrictAdminLayout />}>
          ...
          <Route
            ...
            element={<DistrictAdminTeachersAndStudents />}
          />
          <Route
          ...
          />
          <Route
            path="/district-admin/class-detail/:subjectId"
            element={<DistrictAdminClassdetails />}
          />
          <Route
            path="/district-admin/student-profile"
            element={<DistrictAdminStudentprofile />}
          />
          <Route
            path="/district-admin/student-baseline-assesment"
            element={<DistrictAdminStudentbaseline />}
          />
          <Route
            path="/district-admin/student-lesson-quiz/:studentId"
            element={<DistrictAdminStudentLessonquiz />}
          />
          <Route
            path="/district-admin/student-subject-summative/:subjectId"
            element={<DistrictAdminSubjectSummativedetails />}
          />
          <Route
            path="/district-admin/student-subject-detail/:subjectId"
            element={<DistrictAdminSubjectDetails />}
          />
          <Route
            path="/district-admin/subject-baseline-detail/:subjectId"
            element={<DistrictAdminSubjectBaselinedetails />}
          />
          <Route
            path="/district-admin/subject-lesson-detail/:subjectId/:lessonId"
            element={<DistrictAdminSubjectLessondetail />}
          />

          <Route
            path="/district-admin/teacher-profile"
            element={<DistrictAdminTeacherProfile />}
          />
          <Route
            path="/district-admin/student-summative"
            element={<DistrictAdminSummative />}
          />
          <Route
            path="/district-admin/progress-and-score"
            element={<DistrictAdminProgressAndScore />}
          />
          <Route
            path="/district-admin/progress-student-baseline-assessment"
            element={<DistrictAdminStudentbaseline />}
          />
          <Route
            path="/district-admin/progress-student-summative-assessment"
            element={<DistrictAdminSummative />}
          />
          <Route
            path="/district-admin/progress-student-lesson-quiz"
            element={<DistrictAdminStudentLessonquiz />}
          />
          ...
          />
          <Route
            path="/district-admin/students/profile"
            element={<DistrictAdminStudentprofile />}
          />
          <Route
            path="/district-admin-student-profiles"
            element={<DistrictAdminStudentprofile />}
          />
          <Route
            path="/district-admin/class/detail/:subjectId"
          ...
          />
          <Route
            path="/district-admin/students-summative"
            element={<DistrictAdminSummative />}
          />
          <Route
            path="/district-admin/student-lesson/quiz/:studentId"
